...
namespace OnlineStore.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ProductCategoriesController(OnlineStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var onlineStoreContext = _context.ProductCategory.Include(p => p.Category).Include(p => p.Product);
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryId,ProductId")] ProductCategory productCategory)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Category, "Id", "Name", productCategory.CategoryId);
